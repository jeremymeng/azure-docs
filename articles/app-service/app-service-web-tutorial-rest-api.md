...
4. Add the following lines into `package.json`.  The code generated by Swaggerize doesn't specify a version for Node.js engine. Without the version, Azure would use the default version of `0.10.18` which isn't compatible with the generated code.
